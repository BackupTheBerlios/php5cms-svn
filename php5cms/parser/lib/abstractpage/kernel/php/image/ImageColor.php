...
class ImageColor extends PEAR
{
    ...
    */
    ...
    /**
    * Boolean value for determining whether colors outputted should be websafe or not.  
	* Defaults to false.
	*
    * @access private
    * @see    setWebSafe
    */
    ...
    /**
    * The websafe ranges we use to determine where to set each value.  
	* The key is the websafe part, and the value is the non-websafe value.
	*
    * @access private
    */
    var $websafe = array(   
	...
	{
		$color = ImageColor::_splitColor( $color );
    ...
    {
		return ImageColor::_returnColor( $color );
    }
    ...
    {
		$return = ImageColor::_splitColor( $hex );
        $return['hex'] = $hex;
    ...
    {
		return ImageColor::hex2rgb( ImageColor::hsv2hex( $h, $s, $v ) );
    }
    ...
    {
		$this->color1 = ImageColor::_splitColor( $col1 );
        $this->color2 = ImageColor::_splitColor( $col2 );
    }
