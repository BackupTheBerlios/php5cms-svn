...
class OperatorMinus extends BinaryOperator 
{
	 ...
	 * @access public
	 */
	function OperatorMinus( $op1, $op2 ) 
	{
	...
	function evals() 
	{
        ...
        if ( $const1 && $arg1->evalf() == 0 ) 
			return new UnaryMinus( $arg2 );
			
        if ( $const2 && $arg2->evalf() == 0 ) 
			return $arg1;

        if ( isset( $arg1->prop["var"] ) && isset( $arg2->prop["var"] ) && $arg1->name == $arg2->name )
             return new Constant( 0 );

        return new OperatorMinus( $arg1, $arg2 );
	}
} // END OF OperatorMinus
