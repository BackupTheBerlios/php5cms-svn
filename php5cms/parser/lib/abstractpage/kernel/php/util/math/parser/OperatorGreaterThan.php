...
class OperatorGreaterThan extends BinaryOperator 
{
	/**
  	 * Constructor
	 *
	 * @access public
	 */
	function OperatorGreaterThan( $op1, $op2 ) 
	{
	...
	function evals() 
	{
        ...
        return new OperatorGreaterThan( $arg1, $arg2 );
	}
} // END OF OperatorGreaterThan
