...
/**
 * Class to generate a random 'readable' word (currently english-only). 
 * This is useful if you want to randomly generate passwords that your user 
 * can read and remember (instead of giving them a bunch of numbers). 
 * Some examples: Huchafo, Pequizu, Zequiju, Chomoxy ... ).
 *
 * @package util_text
 */
