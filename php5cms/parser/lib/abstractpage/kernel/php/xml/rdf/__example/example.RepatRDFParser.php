...
function my_start_parse_type_literal_handler( $user_data )
{	
	printf( "start parse type literal<br/>" );
}

function my_end_parse_type_literal_handler( $user_data )
{
	printf( "end parse type literal<br/>" );
}

function my_start_element_handler( $user_data, $name, $attributes )
{
	printf( "start element: $name<br/>\n" );
}

function my_end_element_handler( $user_data, $name )
{
	printf( "end element: %s<br/>\n", $name );
}

function my_character_data_handler( $user_data, $s, $len )
{
	printf( "characters: $s" );
	printf( "<br/>\n" );
}
