...
class SessionUtil extends Base
{
	/**
	 * @access protected
	 */
	 ...
	 * @access public
	 */
	public function createTransmitString() 
	{
		$str =  "";
		$i   = 1;
	 ...
	 * @access public
	 */
	public function readTransmitString() 
	{
		$i = 1;
		while ( 1 )
		{
	 ...
	 * @access public
	 */
	public function getSessionVars( $enc_data )
	{
	 ...
	 * @static
	 */
	public function getUniqueID( $length = 32, $pool = "" )
	{ 
	 ...
	 * @static
	 */
	public function getUniqueID_md5()
	{ 
		mt_srand( (double)microtime() * 1000000 ); 
	 ...
	 * @access protected
	 */
	protected function _readSessions()
	{
