...
class I18N_Locale_nl_NL extends I18N_Locale
{	
	/**
	 * Constructor
	 */
	function I18N_Locale_nl_NL()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
		$this->regionalSettings = array(
			...
			I18N_REGIONAL_COUNTRY				=> 'Netherlands',
			I18N_REGIONAL_LANGUAGE_NAME			=> 'Dutch',
			I18N_REGIONAL_INTL_LANGUAGE_NAME	=> 'Dutch'
		);
