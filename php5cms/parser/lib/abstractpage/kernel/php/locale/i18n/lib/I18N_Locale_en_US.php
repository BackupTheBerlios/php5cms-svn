...
class I18N_Locale_en_US extends I18N_Locale
{								
	/**
	 * Constructor
	 */
	function I18N_Locale_en_US()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
		$this->regionalSettings = array(
			...
			I18N_REGIONAL_COUNTRY				=> 'United States',
	    ...
	    $this->currencyFormats = array(
			I18N_CURRENCY_LOCAL  		=> array( '% US Dollar', '2' , '.' , ',' ),
			I18N_CURRENCY_SYMBOL_INTL  	=> array( 'USD %', '2' , '.' , ',' ),
			I18N_CURRENCY_SYMBOL 		=> array( '$%',    '2' , '.' , ',' )
		);	
	}
} // END OF I18N_Locale_en_US
