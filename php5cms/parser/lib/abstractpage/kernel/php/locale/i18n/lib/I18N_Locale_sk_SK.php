...
class I18N_Locale_sk_SK extends I18N_Locale
{	
	/**
	 * Constructor
	 */
	function I18N_Locale_sk_SK()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
		$this->regionalSettings = array(
			...
			I18N_REGIONAL_COUNTRY				=> 'Slovakia (Slovak Republic)',
			I18N_REGIONAL_LANGUAGE_NAME			=> 'Slovak',
			I18N_REGIONAL_INTL_LANGUAGE_NAME	=> 'Slovak'
		);
    	...
    	$this->currencyFormats = array(
			I18N_CURRENCY_LOCAL  		=> array( '% sk', '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL_INTL  	=> array( '% sl', '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL 		=> array( '% sk', '2', ',', '.' )
		);
	}
} // END OF I18N_Locale_sk_SK
