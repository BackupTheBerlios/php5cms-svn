...
class I18N_Locale_sv_SE extends I18N_Locale
{	
	/**
	 * Constructor
	 */
	function I18N_Locale_sv_SE()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
		$this->regionalSettings = array(
			...
			I18N_REGIONAL_COUNTRY				=> 'Sweden',
			I18N_REGIONAL_LANGUAGE_NAME			=> 'Swedish',
			I18N_REGIONAL_INTL_LANGUAGE_NAME	=> 'Svenska'
		);
    	...
    	$this->currencyFormats = array(
			I18N_CURRENCY_LOCAL  		=> array( '% Svenska kronor', '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL_INTL  	=> array( '% SEK', '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL 		=> array( '% kr', '2', ',', '.' )
		);	
	}
} // END OF I18N_Locale_sv_SE
