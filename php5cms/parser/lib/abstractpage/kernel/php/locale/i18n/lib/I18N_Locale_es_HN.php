...
class I18N_Locale_es_HN extends I18N_Locale
{	
	/**
	 * Constructor
	 */
	function I18N_Locale_es_HN()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
		$this->regionalSettings = array(
			...
			I18N_REGIONAL_COUNTRY				=> 'Honduras',
    	...
    	$this->currencyFormats = array(
			I18N_CURRENCY_LOCAL  		=> array( 'L%', '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL_INTL  	=> array( 'L%', '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL 		=> array( 'L%', '2', ',', '.' )
		);	
	}
} // END OF I18N_Locale_es_HN
