...
class I18N_Locale_es_VE extends I18N_Locale
{	
	/**
	 * Constructor
	 */
	function I18N_Locale_es_VE()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
		$this->regionalSettings = array(
			...
			I18N_REGIONAL_COUNTRY				=> 'Venezuela',
    	...
    	$this->currencyFormats = array(
			I18N_CURRENCY_LOCAL  		=> array( 'Bs%', '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL_INTL  	=> array( 'Bs%', '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL 		=> array( 'Bs%', '2', ',', '.' )
		);	
	}
} // END OF I18N_Locale_es_VE
