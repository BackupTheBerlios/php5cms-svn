...
class I18N_Locale_tr_TR extends I18N_Locale
{	
	/**
	 * Constructor
	 */
	function I18N_Locale_tr_TR()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
		$this->regionalSettings = array(
			...
			I18N_REGIONAL_COUNTRY				=> 'Turkey',
			I18N_REGIONAL_LANGUAGE_NAME			=> 'Turkish',
			I18N_REGIONAL_INTL_LANGUAGE_NAME	=> 'Turkish'
		);
    	...
    	$this->currencyFormats = array(
			I18N_CURRENCY_LOCAL  		=> array( '% TL', '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL_INTL  	=> array( '% TL', '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL 		=> array( '% TL', '2', ',', '.' )
		);
	}
} // END OF I18N_Locale_tr_TR
