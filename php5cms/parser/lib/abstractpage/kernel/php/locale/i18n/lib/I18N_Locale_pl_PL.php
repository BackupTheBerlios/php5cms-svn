...
class I18N_Locale_pl_PL extends I18N_Locale
{
	/**
	 * Constructor
	 */
	function I18N_Locale_pl_PL()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
    	...
    	$this->currencyFormats = array(
			I18N_CURRENCY_LOCAL  		=> array( '% Polski z³oty' ,  '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL_INTL  	=> array( '% PLN' , '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL 		=> array( '% z³' ,  '2', ',', '.' )
		);
	}
} // END OF I18N_Locale_pl_PL
