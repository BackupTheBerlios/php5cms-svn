...
class I18N_Locale_in extends I18N_Locale
{	
	/**
	 * Constructor
	 */
	function I18N_Locale_in()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
		$this->regionalSettings = array(
			...
			I18N_REGIONAL_LANGUAGE_NAME			=> 'Indonesian',
			I18N_REGIONAL_INTL_LANGUAGE_NAME	=> 'Indonesian'
		);
    	...
    	$this->currencyFormats = array(
			I18N_CURRENCY_LOCAL  		=> array( 'Rp%', '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL_INTL  	=> array( 'Rp%', '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL 		=> array( 'Rp%', '2', ',', '.' )
		);
	}
} // END OF I18N_Locale_in
