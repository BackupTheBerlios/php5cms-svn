...
class I18N_Locale_hu_HU extends I18N_Locale
{	
	/**
	 * Constructor
	 */
	function I18N_Locale_hu_HU()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
    	...
    	$this->currencyFormats = array(
			...
			I18N_CURRENCY_SYMBOL_INTL  	=> array( '% Ft', '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL 		=> array( '% Ft', '2', ',', '.' )
		);
	}
} // END OF I18N_Locale_hu_HU
