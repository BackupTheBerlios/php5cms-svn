...
class I18N_Locale_da_DK extends I18N_Locale
{	
	/**
	 * Constructor
	 */
	function I18N_Locale_da_DK()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
		$this->regionalSettings = array(
			...
			I18N_REGIONAL_COUNTRY				=> 'Denmark',
			I18N_REGIONAL_LANGUAGE_NAME			=> 'Danish',
			I18N_REGIONAL_INTL_LANGUAGE_NAME	=> 'Danish'
		);
