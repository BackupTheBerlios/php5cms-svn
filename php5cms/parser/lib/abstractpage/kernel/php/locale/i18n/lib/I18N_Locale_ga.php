...
class I18N_Locale_ga extends I18N_Locale
{	
	/**
	 * Constructor
	 */
	function I18N_Locale_ga()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
		$this->regionalSettings = array(
			...
			I18N_REGIONAL_LANGUAGE_NAME			=> 'Irish',
			I18N_REGIONAL_INTL_LANGUAGE_NAME	=> 'Irish'
		);
    	...
    	$this->timeFormats = array(
			...
			I18N_DATETIME_FULL      => 'H:i \o\'\c\l\o\c\k'
		); 
