...
class SimpleSession extends PEAR 
{
	/**
	 * @access public
	 */
	 ...
	 * @access private
	 */
	var $_sessPropTemplate = array();
	
	/**
	 * @access private
	 */
	var $_sessPrefix = 'ap_sess_';
	 ...
	 * @access private
	 */
	var $_sessStarted = null;
	
	/**
	 * @access private
	 */
	var $_sessInfoList = array();
	 ...
	 * Destructor
	 */
	function _SimpleSession()
	{
		$pc = $this->_pathCheck( $this->_sessPropTemplate['path'] );
		
		if ( $pc && !PEAR::isError( $pc ) )
			$this->writeClose();
	}
	 ...
	 * @access public
	 */
	function register( $key, &$value, $sessName = 'default' ) 
	{
	 ...
	 * @access public
	 */	
	function unRegister( $key, $sessName = 'default' ) 
	{
		if ( !isset( $this->_isValid[$sessName] ) ) 
			$this->_init( $sessName );
	 ...
	 * @access public
	 */
	function isRegistered( $key, $sessName = 'default' ) 
	{
		if ( !isset( $this->_isValid[$sessName] ) ) 
			$this->_init( $sessName );
	 ...
	 * @access public
	 */	
	function &getVar( $key, $sessName = 'default' ) 
	{
		if ( !isset( $this->_isValid[$sessName] ) ) 
			$this->_init( $sessName );
	 ...
	 * @access public
	 */	
	function destroy( $sessName = 'default' ) 
	{  
		do 
		{
	 ...
	 * @access public
	 */
	function reset( $sessName = 'default' ) 
	{
		if ( !empty( $this->_sessInfoList[$sessName] ) ) 
		{
	 ...
	 * @access public
	 */
	function setProperty( $prop, $sessName = 'default' ) 
	{
		if ( !isset( $this->_isValid[$sessName] ) ) 
			$this->_init( $sessName );
	 ...
	 * @access private
	 */	
	function _copyProp( $fromProp, &$toProp ) 
	{
