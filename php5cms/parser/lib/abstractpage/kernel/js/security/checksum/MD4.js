...
MD4.prototype = new Base();
MD4.prototype.constructor = MD4;
MD4.superclass = Base.prototype;
 ...
 * @access public
 */
MD4.prototype.calc = function( str )
{
 ...
 * @access public
 */
MD4.prototype.rhex = function( num )
{
	var str = "";

	for ( var j = 0; j <= 3; j++ )
		str += MD4.hex_chr.charAt( ( num >> ( j * 8 + 4 ) ) & 0x0F ) + MD4.hex_chr.charAt( ( num >> ( j * 8 ) ) & 0x0F );
 ...
 * @access public
 */
MD4.prototype.str2blks_MD5 = function( str )
{
 ...
 * @access public
 */
MD4.prototype.safe_add = function( x, y )
{
 ...
 * @access public
 */
MD4.prototype.rol = function( num, cnt )
{
 ...
 * @access public
 */
MD4.prototype.cmn = function( q, a, b, x, s, t )
{
 ...
 * @access public
 */
MD4.prototype.ffMD4 = function( a, b, c, d, x, s )
{
 ...
 * @access public
 */
MD4.prototype.ggMD4 = function( a, b, c, d, x, s )
{
 ...
 * @access public
 */
MD4.prototype.hhMD4 = function( a, b, c, d, x, s )
{
