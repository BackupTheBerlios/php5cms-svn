...
using( 'peer.mail.mime.Mail_MimePart' );
...
class Mail_Mime extends PEAR
{
     ...
     * @return mixed true on success or an Error object
     * @access public
     */
     ...
     *
     * @param string $file The image file name || image data itself
     ...
     *
     * @param string $file The file name of the file to attach || the file data itself
     * @param string $c_type The content type
