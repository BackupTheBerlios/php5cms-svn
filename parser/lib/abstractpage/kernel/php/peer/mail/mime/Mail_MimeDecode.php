...
class Mail_MimeDecode extends PEAR
{
    ...
    function decode( $params = null )
    {
		...
		else if ( !isset($this->mailMimeDecode ) ) 
		{
		...
		else 
		{
            ...
            if ( $structure === false )
                $structure = PEAR::raiseError( 'Unable to decode.' );
        }
     ...
     * }
	 *
     * @return mixed   array of recipeint, headers, body or an Error
     * @access public
     */
    function getSendArray()
    {
		...
		if ( !$headerlist )
            return PEAR::raiseError( 'Message did not contain headers.' );
        ...
        if ( $to == "" )
            return PEAR::raiseError( 'Message did not contain any recipents.' );
            ...
            switch ( strtolower( $content_type['value'] ) ) 
			{
                ...
                case 'multipart/mixed':
					...
					for ( $i = 0; $i < count( $parts ); $i++ ) 
					{
                        ...
                        if ( $part === false )
                            $part = PEAR::raiseError( 'Cannot proceed.' );
