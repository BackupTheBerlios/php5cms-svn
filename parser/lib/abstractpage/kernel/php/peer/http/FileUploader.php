...
class FileUploader extends Base
{
	 ...
	 * @access public
	 */
	public function __construct( $file, $fileName, $fileType,	$maximumFileSize = "76800" )
	{
		$this->file		   = $file;
	 ...
	 * @return string
	 */
	public function upload( $location, $newFileName ) 
	{
	 ...
	 * @return string
	 */
	public function getOriginalFile( $location ) 
	{
	 ...
	 * @return boolean
	 */
	public function copyToOriginalFile( $originalFile ) 
	{
	 ...
	 * @return string
	 */
	public function getNewFile( $location, $newFileName ) 
	{
	 ...
	 * @return boolean
	 */
	public function renameOriginalToNew( $originalFile, $newFile ) 
	{
	 ...
	 * @access public
	 */
	public function removeDocumentRoot( $newFile ) 
	{
	 ...
	 * @access public
	 */
	public function addArchiveTypes() 
	{
		foreach ( $this->registeredTypes as $type => $value ) 
		{
	 ...
	 * @access public
	 */
	public function isFileTypeValid() 
	{
