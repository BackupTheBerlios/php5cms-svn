...
$circle->addChild( new SvgAnimate( "fill", "CSS", "green", "red", "", "3s", "freeze" ) );

// Make the circle a child of g.
$g->addChild( $circle );

// Create and animate some text.
$text = new SvgText( "0", "0", "SVG and PHP", "font-size:20;text-anchor:middle;", "" );
$text->addChild( new SvgAnimate( "font-size", "auto", "0", "20", "", "3s", "freeze" ) );
...
<circle cx="0" cy="0" r="100" style="stroke-width:3" >
	<animate attributeName="r" attributeType="XML" from="0" to="75" dur="3s" fill="freeze" />
	<animate attributeName="fill" attributeType="CSS" from="green" to="red" dur="3s" fill="freeze" />
</circle>

<text x="0" y="0" style="font-size:20;text-anchor:middle;" >SVG and PHP
	<animate attributeName="font-size" attributeType="auto" from="0" to="20" dur="3s" fill="freeze" />
</text>
</g>
</svg>
*/
