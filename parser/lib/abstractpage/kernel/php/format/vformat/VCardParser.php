...
class VCardParser extends PEAR
{
    /** 
     ...
     * @return array An array of of vCard information extracted from the file.
     * @see VCardParser::fromText()
     * @see VCardParser::_fromArray()
     */
     ...
     * @access public
     * @param array $filename The filename to read for vCard information.
     * @return string|bool The contents of the file if it exists and is readable, or boolean false if not.
     * @see VCardParser::fromFile()
     */
     ...
     * @return array An array of vCard information extracted from the source text.
     * @see VCardParser::_fromArray()
     */
     ...
     * @param bool $convertSingle If splitting the string results in a single array element, return a string instead of a one-element array.
     ...
     * 
     * @access private
     * @param string $text A left-part (before-the-colon part) from a vCard line.
     ...
     * @param string $text A right-part (after-the-colon part) from a vCard line.
     * @return void
     */
     ...
     *
     * @access private
     * @param string $text The right-part (after-the-colon part) of a vCard line.
