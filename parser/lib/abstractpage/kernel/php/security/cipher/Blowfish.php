...
|         Igor Ribeiro de Assis <igor21@terra.com.br>                  |
+----------------------------------------------------------------------+
*/


/**
  * This Class is a implementation of the Blowfish Crypt Algorithm
  * based on Bruce Schneier Code in Applied Cryptography.
  *
  * @package security_cipher
  */

class Blowfish extends PEAR 
{
    /** 
     * S-Box 0
	 *
