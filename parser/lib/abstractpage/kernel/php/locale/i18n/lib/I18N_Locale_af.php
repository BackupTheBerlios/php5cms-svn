...
class I18N_Locale_af extends I18N_Locale
{	
	/**
	 * Constructor
	 */
	function I18N_Locale_af()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
		$this->regionalSettings = array(
			...
			I18N_REGIONAL_LANGUAGE_NAME			=> 'Afrikaans',
			I18N_REGIONAL_INTL_LANGUAGE_NAME	=> 'Afrikaans'
		);
