...
class I18N_Locale_en_GB extends I18N_Locale
{								
	/**
	 * Constructor
	 */
	function I18N_Locale_en_GB()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
		$this->regionalSettings = array(
			...
			I18N_REGIONAL_COUNTRY				=> 'United Kingdom',
    	...
    	$this->dateFormats = array(
			I18N_DATETIME_SHORT     => 'm/d/Y',
			I18N_DATETIME_DEFAULT   => 'm/d/Y',
	    ...
	    $this->currencyFormats = array(
			I18N_CURRENCY_LOCAL  		=> array( '% British pound',  '2' , '.' , ',' ),
			I18N_CURRENCY_SYMBOL_INTL  	=> array( '% BSP', '2' , '.' , ',' ),
			I18N_CURRENCY_SYMBOL 		=> array( '% £',   '2' , '.' , ',' )
		);	
	}
} // END OF I18N_Locale_en_GB
