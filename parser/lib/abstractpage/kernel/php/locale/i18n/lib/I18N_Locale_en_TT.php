...
class I18N_Locale_en_TT extends I18N_Locale
{	
	/**
	 * Constructor
	 */
	function I18N_Locale_en_TT()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
		$this->regionalSettings = array(
			...
			I18N_REGIONAL_COUNTRY				=> 'Trinidad and Tobago',
	    ...
	    $this->currencyFormats = array(
			...
			I18N_CURRENCY_SYMBOL_INTL  	=> array( 'TT$%', '2' , '.' , ',' ),
			I18N_CURRENCY_SYMBOL 		=> array( '$%',   '2' , '.' , ',' )
		);
	}
} // END OF I18N_Locale_en_TT
