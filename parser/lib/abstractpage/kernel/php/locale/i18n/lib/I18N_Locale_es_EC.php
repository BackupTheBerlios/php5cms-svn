...
class I18N_Locale_es_EC extends I18N_Locale
{	
	/**
	 * Constructor
	 */
	function I18N_Locale_es_EC()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
    	...
    	$this->currencyFormats = array(
			I18N_CURRENCY_LOCAL  		=> array( 'S/%', '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL_INTL  	=> array( 'S/%', '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL 		=> array( 'S/%', '2', ',', '.' )
		);	
	}
} // END OF I18N_Locale_es_EC
