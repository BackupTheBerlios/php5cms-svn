...
class I18N_Locale_sl_SI extends I18N_Locale
{	
	/**
	 * Constructor
	 */
	function I18N_Locale_sl_SI()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
		$this->regionalSettings = array(
			...
			I18N_REGIONAL_COUNTRY				=> 'Slovenia',
			I18N_REGIONAL_LANGUAGE_NAME			=> 'Slovenian',
			I18N_REGIONAL_INTL_LANGUAGE_NAME	=> 'Slovenian'
		);
