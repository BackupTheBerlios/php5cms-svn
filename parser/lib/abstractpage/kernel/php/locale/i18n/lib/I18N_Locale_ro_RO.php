...
class I18N_Locale_ro_RO extends I18N_Locale
{	
	/**
	 * Constructor
	 */
	function I18N_Locale_ro_RO()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
		$this->regionalSettings = array(
			...
			I18N_REGIONAL_COUNTRY				=> 'Romania',
			I18N_REGIONAL_LANGUAGE_NAME			=> 'Romanian',
			I18N_REGIONAL_INTL_LANGUAGE_NAME	=> 'Romanian'
		);
    	...
    	$this->currencyFormats = array(
			I18N_CURRENCY_LOCAL  		=> array( '% LEI', '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL_INTL  	=> array( '% LEI', '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL 		=> array( '% LEI', '2', ',', '.' )
		);	
	}
} // END OF I18N_Locale_ro_RO
