...
class I18N_Locale_sr extends I18N_Locale
{	
	/**
	 * Constructor
	 */
	function I18N_Locale_sr()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
		$this->regionalSettings = array(
			...
			I18N_REGIONAL_LANGUAGE_NAME			=> 'Serbian',
			I18N_REGIONAL_INTL_LANGUAGE_NAME	=> 'Serbian'
		);
    	...
    	$this->currencyFormats = array(
			I18N_CURRENCY_LOCAL  		=> array( '% Din.', '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL_INTL  	=> array( '% Din.', '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL 		=> array( '% Din.', '2', ',', '.' )
		);	
	}
} // END OF I18N_Locale_sr
