...
class I18N_Locale_en_ZA extends I18N_Locale
{	
	/**
	 * Constructor
	 */
	function I18N_Locale_en_ZA()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
		$this->regionalSettings = array(
			...
			I18N_REGIONAL_COUNTRY				=> 'South Africa',
	    ...
	    $this->currencyFormats = array(
			...
			I18N_CURRENCY_SYMBOL 		=> array( 'R%', '2' , '.' , ',' )
		);
	}
} // END OF I18N_Locale_en_ZA
