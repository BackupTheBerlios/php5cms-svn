...
class I18N_Locale_es_PY extends I18N_Locale
{	
	/**
	 * Constructor
	 */
	function I18N_Locale_es_PY()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
		$this->regionalSettings = array(
			...
			I18N_REGIONAL_COUNTRY				=> 'Paraguay',
    	...
    	$this->currencyFormats = array(
			I18N_CURRENCY_LOCAL  		=> array( 'G%', '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL_INTL  	=> array( 'G%', '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL 		=> array( 'G%', '2', ',', '.' )
		);	
	}
} // END OF I18N_Locale_es_PY
