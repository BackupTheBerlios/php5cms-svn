...
class I18N_Locale_de extends I18N_Locale
{	
	/**
	 * Constructor
	 */
	function I18N_Locale_de()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
		$this->regionalSettings = array(
			...
			I18N_REGIONAL_LANGUAGE_NAME			=> 'German',
			I18N_REGIONAL_INTL_LANGUAGE_NAME	=> 'GER'
		);
