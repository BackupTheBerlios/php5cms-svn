...
class I18N_Locale_es_SV extends I18N_Locale
{	
	/**
	 * Constructor
	 */
	function I18N_Locale_es_SV()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
		$this->regionalSettings = array(
			...
			I18N_REGIONAL_COUNTRY				=> 'El Salvador',
...
/**
    	...
    	$this->currencyFormats = array(
			...
			I18N_CURRENCY_SYMBOL 		=> array( 'C%', '2', ',', '.' )
		);	
	}
} // END OF I18N_Locale_es_SV
