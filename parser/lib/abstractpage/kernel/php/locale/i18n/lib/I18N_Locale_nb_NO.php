...
class I18N_Locale_nb_NO extends I18N_Locale
{	
	/**
	 * Constructor
	 */
	function I18N_Locale_nb_NO()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
		$this->regionalSettings = array(
			...
			I18N_REGIONAL_LANGUAGE_NAME			=> 'Norsk (Bokm&aring;l)',
			I18N_REGIONAL_INTL_LANGUAGE_NAME	=> 'Norwegian (Bokm&aring;l)'
		);
