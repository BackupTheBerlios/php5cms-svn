...
class I18N_Locale_cs_CZ extends I18N_Locale
{	
	/**
	 * Constructor
	 */
	function I18N_Locale_cs_CZ()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
		$this->regionalSettings = array(
			...
			I18N_REGIONAL_COUNTRY				=> 'Czech Republic',
			I18N_REGIONAL_LANGUAGE_NAME			=> 'Czech',
			I18N_REGIONAL_INTL_LANGUAGE_NAME	=> 'Czech'
		);
    	...
    	$this->currencyFormats = array(
			...
			I18N_CURRENCY_LOCAL  		=> array( '% Czech koruna' , '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL_INTL  	=> array( 'CSK %' , '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL 		=> array( '% CSK' , '2', ',', '.' )
		);
	}
} // END OF I18N_Locale_cs_CZ
