...
class I18N_Locale_hr extends I18N_Locale
{	
	/**
	 * Constructor
	 */
	function I18N_Locale_hr()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
		$this->regionalSettings = array(
			...
			I18N_REGIONAL_LANGUAGE_NAME			=> 'Croatian',
			I18N_REGIONAL_INTL_LANGUAGE_NAME	=> 'Croatian'
		);
    	...
    	$this->currencyFormats = array(
			I18N_CURRENCY_LOCAL  		=> array( 'kn %', '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL_INTL  	=> array( 'kn %', '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL 		=> array( 'kn %', '2', ',', '.' )
		);
	}
} // END OF I18N_Locale_hr
