...
class I18N_Locale_sq extends I18N_Locale
{	
	/**
	 * Constructor
	 */
	function I18N_Locale_sq()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
		$this->regionalSettings = array(
			...
			I18N_REGIONAL_LANGUAGE_NAME			=> 'Albanian',
			I18N_REGIONAL_INTL_LANGUAGE_NAME	=> 'Albanian'
		);
    	...
    	$this->currencyFormats = array(
			I18N_CURRENCY_LOCAL  		=> array( '% Lek', '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL_INTL  	=> array( '% Lek', '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL 		=> array( '% Lek', '2', ',', '.' )
		);
	}
} // END OF I18N_Locale_sq
