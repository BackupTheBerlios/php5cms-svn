...
class I18N_Locale_es_GT extends I18N_Locale
{	
	/**
	 * Constructor
	 */
	function I18N_Locale_es_GT()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
		$this->regionalSettings = array(
			...
			I18N_REGIONAL_COUNTRY				=> 'Guatemala',
    	...
    	$this->currencyFormats = array(
			I18N_CURRENCY_LOCAL  		=> array( 'Q%', '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL_INTL  	=> array( 'Q%', '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL 		=> array( 'Q%', '2', ',', '.' )
		);	
	}
} // END OF I18N_Locale_es_GT
