...
class I18N_Locale_es_PA extends I18N_Locale
{	
	/**
	 * Constructor
	 */
	function I18N_Locale_es_PA()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
    	...
    	$this->currencyFormats = array(
			I18N_CURRENCY_LOCAL  		=> array( 'B%', '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL_INTL  	=> array( 'B%', '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL	 	=> array( 'B%', '2', ',', '.' )
		);	
	}
} // END OF I18N_Locale_es_PA
