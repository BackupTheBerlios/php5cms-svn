...
class I18N_Locale_sv_FI extends I18N_Locale
{	
	/**
	 * Constructor
	 */
	function I18N_Locale_sv_FI()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
		$this->regionalSettings = array(
			...
			I18N_REGIONAL_LANGUAGE_NAME			=> 'Svenska',
			I18N_REGIONAL_INTL_LANGUAGE_NAME	=> 'Swedish'
		);
