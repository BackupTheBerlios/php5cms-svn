...
class I18N_Locale_lt_LT extends I18N_Locale
{	
	/**
	 * Constructor
	 */
	function I18N_Locale_lt_LT()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
		$this->regionalSettings = array(
			...
			I18N_REGIONAL_COUNTRY				=> 'Lithuania',
    	...
    	$this->currencyFormats = array(
			I18N_CURRENCY_LOCAL  		=> array( '% Lt', '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL_INTL  	=> array( '% Lt', '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL 		=> array( '% Lt', '2', ',', '.' )
		);
	}
} // END OF I18N_Locale_lt_LT
