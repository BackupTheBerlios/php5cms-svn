...
class I18N_Locale_es_DO extends I18N_Locale
{	
	/**
	 * Constructor
	 */
	function I18N_Locale_es_DO()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
		$this->regionalSettings = array(
			...
			I18N_REGIONAL_COUNTRY				=> 'Dominican Republic',
    	...
    	$this->currencyFormats = array(
			...
			I18N_CURRENCY_SYMBOL_INTL  	=> array( 'RD$%', '2', ',', '.' ),
			I18N_CURRENCY_SYMBOL 		=> array( '$%',   '2', ',', '.' )
		);	
	}
} // END OF I18N_Locale_es_DO
