...
class I18N_Locale_en_JM extends I18N_Locale
{	
	/**
	 * Constructor
	 */
	function I18N_Locale_en_JM()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
	    ...
	    $this->currencyFormats = array(
			...
			I18N_CURRENCY_SYMBOL_INTL  	=> array( 'J$%', '2' , '.' , ',' ),
			I18N_CURRENCY_SYMBOL 		=> array( '$%',  '2' , '.' , ',' )
		);
	}
} // END OF I18N_Locale_en_JM
