...
class I18N_Locale_fi_FI extends I18N_Locale
{	
	/**
	 * Constructor
	 */
	function I18N_Locale_fi_FI()
	{
		$this->_populate();
	}
	...
	function _populate()
	{
		$this->regionalSettings = array(
			...
			I18N_REGIONAL_COUNTRY				=> 'Finland',
			I18N_REGIONAL_LANGUAGE_NAME			=> 'Finnish',
			I18N_REGIONAL_INTL_LANGUAGE_NAME	=> 'Finnish'
		);
