...
class Synonyms_ru extends Synonyms
{
	/**
	 * Constructor
	 *
	...
	function _populate()
	{
		$this->synonyms = array(
			...
			"Афера" => "Мошенничество",
			"Басня" => "Анекдот",
			"Безбрежность" => "Обширность",
			"Безвластие" => "Анархия",
			"Безвредность" => "Безопасность",
			"Безграничность" => "Бесконечность",
			"Бездна" => "Пропасть",
			"Безнадежность" => "Отчаяние",
			"Безответность" => "Кротость",
			"Безрезультатность" => "Бесполезность",
			"Безропотность" => "Кротость",
			"Безумие" => "Безрассудство",
			"Безумие" => "Сумасшествие",
			"Беспорядок" => "Анархия",
			"Беспорядок" => "Смута",
			"Беспорядок" => "Хаос",
			"Беспредельность" => "Обширность",
			"Беспримерность" => "Необыкновенность",
			"Бессердечность" => "Черствость",
			"Бесспорность" => "Неопровержимость",
			"Бесстрастность" => "Спокойствие",
			"Бесцельность" => "Бесполезность",
			"Бесцеремонность" => "Панибратство",
			"Бесцеремонность" => "Фамильярность",
			"Бесчеловечность" => "Жестокость",
			"Бесчинство" => "Буйство",
			"Бешенство" => "Неистовство",
			"Битва" => "Сражение",
			"Благоволение" => "Доброжелательность",
			"Благословение" => "Одобрение",
			"Близость" => "Интимность",
			"Близость" => "Соседство",
			"Богобоязненность" => "Благочестие",
			...
			"Бойкость" => "Бодрость",
			"Боязливость" => "Робость",
			"Боязливость" => "Трусость",
			"Брезгливость" => "Отвращение",
			"Бремя" => "Тягость",
			"Брюхо" => "Чрево",
			"Будни" => "Повседневность",
			"Буквоедство" => "Мелочность",
			"Бунт" => "Восстание",
			"Вальяжность" => "Величавость",
			"Вдумчивость" => "Серьезность",
			"Везение" => "Удача",
			"Великолепие" => "Роскошь",
			"Величественность" => "Величавость",
			"Венок" => "Венец",
			"Верх" => "Венец",
			"Веселье" => "Веселость",
			"Вещество" => "Материя",
			"Веяние" => "Внушение",
			"Взгляд" => "Воззрение",
			"Вздорность" => "Сварливость",
			"Взыскательность" => "Придирчивость",
			"Вид" => "Облик",
			"Вихрь" => "Ветер",
			"Владение" => "Обладание",
			...
			"Вождение" => "Управление",
			"Возвеличивание" => "Превознесение",
			"Возвышенность" => "Благородство",
			"Возвышенность" => "Духовность",
			"Воздействие" => "Влияние",
			"Воздержанность" => "Воздержание",
			"Воззрение" => "Мнение",
			"Возмездие" => "Наказание",
			...
			"Волнение" => "Потрясение",
			"Вольность" => "Фамильярность",
			"Воодушевленность" => "Энтузиазм",
			"Вооружение" => "Оружие",
			"Вопль" => "Крик",
			"Ворчание" => "Брюзжание",
			...
			"Врачевание" => "Лечение",
			"Вселенная" => "Мир",
			"Выдержанность" => "Спокойствие",
			"Выдержанность" => "Хладнокровие",
			...
			"Доход" => "Прибыль",
			"Дурость" => "Глупость",
			"Душевность" => "Духовность",
			"Единство" => "Цельность",
			"Едкость" => "Язвительность",
			"Жанр" => "Стиль",
			"Желчность" => "Язвительность",
			"Жеманство" => "Величавость",
			"Жертвенник" => "Алтарь",
			"Жесткость" => "Суровость",
			"Живот" => "Чрево",
			...
			"Закономерность" => "Логика",
			"Законченность" => "Цельность",
			"Замечание" => "Критика",
			...
			"Исключительность" => "Необыкновенность",
			"Исполнительность" => "Старание",
			"Испуг" => "Страх",
			"Исступление" => "Горячность",
			"Иступление" => "Неистовство",
			"Исчезновение" => "Гибель",
			"Исчезновение" => "Утрата",
			"Итог" => "Результат",
			"Кабала" => "Неволя",
			...
			"Копирование" => "Подражание",
			"Корыстолюбие" => "Стяжательство",
			"Крохоборство" => "Мелочность",
			"Кругозор" => "Интерес",
			"Культ" => "Поклонение",
			"Лакейство" => "Угодничество",
			"Ласковость" => "Мягкость",
			"Ласковость" => "Нежность",
			"Лекарь" => "Врач",
			"Ликование" => "Радость",
			...
			"Находка" => "Открытие",
			"Находчивость" => "Ловкость",
			"Нахождение" => "Обретение",
			"Небосклон" => "Небеса",
			"Небосклон" => "Небо",
			"Небылица" => "Вымысел",
			"Невежливость" => "Грубость",
			"Невезение" => "Неудача",
			"Невиданность" => "Необыкновенность",
			...
			"Недостижимость" => "Недосягаемость",
			"Недоступность" => "Недосягаемость",
			"Незаслуженность" => "Несправедливость",
			"Неземное" => "Возвышенное",
			"Незначительность" => "Мелкость",
			"Незначительность" => "Ничтожество",
			"Незначительность" => "Суетность",
			"Неизвестность" => "Безвестность",
			"Неискренность" => "Лицемерие",
			"Неискренность" => "Притворство",
			"Неискренность" => "Фальшь",
			"Неискренность" => "Ханжество",
			"Неистовость" => "Необузданность",
			"Неколебимость" => "Стойкость",
			"Некрасивость" => "Безобразность",
			"Некрасивость" => "Уродство",
			"Нелюбезность" => "Грубость",
			"Неминуемость" => "Неизбежность",
			"Ненормальность" => "Извращение",
			"Ненормальность" => "Странность",
			"Ненормальность" => "Уродство",
			"Ненужность" => "Бесполезность",
			"Ненужность" => "Никчемность",
			"Необдуманность" => "Опрометчивость",
			"Необозримость" => "Обширность",
			"Необразованность" => "Варварство",
			"Необъективность" => "Предубеждение",
			"Необъятность" => "Обширность",
			"Неорганизованность" => "Распущенность",
			"Неоригинальность" => "Банальность",
			"Неосмотрительность" => "Опрометчивость",
			"Неосуществимость" => "Невозможность",
			"Неосуществимость" => "Утопия",
			"Неотвратимость" => "Неизбежность",
			"Неподвижность" => "Бездействие",
			"Неподвижность" => "Покой",
			"Непонятность" => "Неясность",
			"Непорочность" => "Невинность",
			"Непоследовательность" => "Половинчатость",
			"Непосредственность" => "Непринужденность",
			"Непостижимость" => "Неясность",
			"Непочтительность" => "Дерзость",
			"Неправда" => "Ложь",
			"Неправда" => "Несправедливость",
			"Неправдоподобность" => "Невероятность",
			"Неправильность" => "Ложность",
			"Непривычность" => "Новизна",
			"Неприличие" => "Непристойность",
			"Непримиримость" => "Жестокость",
			"Непритязательность" => "Простота",
			"Непродолжительность" => "Быстрота",
			"Неразборчивость" => "Неясность",
			"Несдержанность" => "Запальчивость",
			"Несдержанность" => "Необузданность",
			"Несерьезность" => "Беспечность",
			"Несерьезность" => "Легкомыслие",
			"Несерьезность" => "Поверхностность",
			"Неслыханность" => "Необыкновенность",
			"Несогласие" => "Отказ",
			"Несомненность" => "Очевидность",
			"Неудовольствие" => "Недовольство",
			"Неумеренность" => "Чрезмерность",
			"Низкопоклонство" => "Угодничество",
			"Ничтожность" => "Мелкость",
			"Норма" => "Правило",
			"Нюх" => "Интуиция",
			"Нюх" => "Чутье",
			"Обеспеченность" => "Благосостояние",
			"Обольщение" => "Соблазн",
			"Оборона" => "Защита",
			"Обоюдность" => "Взаимность",
			"Образованность" => "Образование",
			"Образованность" => "Ученость",
			"Обусловленность" => "Зависимость",
			"Обходительность" => "Вежливость",
			"Объективность" => "Беспристрастность",
			"Объективность" => "Справедливость",
			"Обыденщина" => "Повседневность",
			"Обыкновенность" => "Заурядность",
			"Обычность" => "Заурядность",
			"Обязательство" => "Обещание",
			"Овация" => "Аплодисменты",
			"Одолжение" => "Услуга",
			"Озабоченность" => "Серьезность",
			"Озлобление" => "Ожесточение",
			"Оккупация" => "Завоевание",
			"Окончание" => "Конец",
			...
			"Ординарность" => "Заурядность",
			"Оригинал" => "Образец",
			"Осанистость" => "Величавость",
			"Осведомленность" => "Знание",
			"Освобождение" => "Избавление",
			"Осквернение" => "Кощунство",
			"Оскопление" => "Кастрация",
			"Особенность" => "Качество",
			"Остервенение" => "Горячность",
			"Остервенение" => "Неистовство",
			"Отверстие" => "Дыра",
			"Отвлеченность" => "Абстракция",
			"Отвратительность" => "Скотство",
			"Отголосок" => "Эхо",
			"Отзвук" => "Эхо",
			"Отзыв" => "Критика",
			...
			"Подмостки" => "Сцена",
			"Подобие" => "Сходство",
			"Подобострастность" => "Почтительность",
			"Подонок" => "Негодяй",
			"Подробность" => "Тонкость",
			"Подробность" => "Частность",
			"Подтверждение" => "Доказательство",
			"Подхалимство" => "Прихлебательство",
			"Похалимство" => "Угодничество",
			"Позиция" => "Положение",
			"Поиск" => "Исследование",
			"Показ" => "Демонстрация",
			"Покладистость" => "Мягкость",
			"Покладистость" => "Податливость",
			"Покладистость" => "Уживчивость",
			...
			"Прекращение" => "Конец",
			"Преобладание" => "Важность",
			"Преобладание" => "Господство",
			"Преподавание" => "Обучение",
			"Преподаватель" => "Учитель",
			"Пресмыкательство" => "Угодничество",
			"Престиж" => "Авторитет",
			"Привидение" => "Тень",
			"Приказ" => "Повеление",
			"Прилежание" => "Старание",
			"Принадлежность" => "Качество",
			"Припадок" => "Горячность",
			"Пристойность" => "Приличие",
			"Пристрастие" => "Вкус",
			"Пристрастие" => "Влечение",
			"Пристрастие" => "Склонность",
			"Пристрастие" => "Слабость",
			"Притеснение" => "Гонение",
			"Причуда" => "Каприз",
			"Причуда" => "Прихоть",
			"Приязнь" => "Расположение",
			"Проба" => "Испытание",
			"Проблеск" => "Искра",
			"Проверка" => "Испытание",
			"Проволочка" => "Медлительность",
			"Проворство" => "Ловкость",
			"Проделка" => "Уловка",
			"Проект" => "План",
			...
			"Пронырливость" => "Ловкость",
			"Прославление" => "Превознесение",
			"Прославление" => "Хвала",
			"Простонародье" => "Чернь",
			"Простосердечие" => "Бесхитростность",
			"Простосердечие" => "Наивность",
			"Простосердечие" => "Невинность",
			"Простосердечие" => "Простота",
			"Просчет" => "Погрешность",
			"Протест" => "Возражение",
			"Протест" => "Опровержение",
			...
			"Развитие" => "Кругозор",
			"Развитие" => "Прогресс",
			"Развращенность" => "Безнравственность",
			"Развязка" => "Конец",
			"Развязность" => "Наглость",
			"Разговорчивость" => "Болтливость",
			"Разговорчивость" => "Словоохотливость",
			"Разгром" => "Поражение",
			"Разлад" => "Несогласие",
			"Разложение" => "Анализ",
			...
			"Разрушение" => "Гибель",
			"Разряд" => "Класс",
			"Ранимость" => "Уязвимость",
			"Рассвет" => "Заря",
			"Распоряжение" => "Повеление",
			"Расследование" => "Анализ",
			"Рассматривание" => "Созерцание",
			"Рассмотрение" => "Критика",
			"Расстройство" => "Огорчение",
			"Расторопность" => "Ловкость",
			"Расхождение" => "Противоречие",
			"Рвение" => "Старание",
			"Реалистичность" => "Правдивость",
			"Рев" => "Крик",
			"Редкость" => "Исключение",
			"Рекомендация" => "Совет",
			...
			"Рост" => "Прогресс",
			"Ротозейство" => "Рассеянность",
			"Рубеж" => "Граница",
			"Рубец" => "Шрам",
			"Рукоплескания" => "Аплодисменты",
			"Ручательство" => "Гарантия",
			"Рыдания" => "Плач",
			"Самовластие" => "Тирания",
			"Самозабвение" => "Восхищение",
			"Самоуничижение" => "Самоунижение",
			"Сан" => "Чин",
			"Сарказм" => "Насмешка",
			"Свершение" => "Успех",
			"Светило" => "Знаменитость",
			"Свободомыслие" => "Либерализм",
			"Своенравие" => "Каприз",
			"Своенравие" => "Прихоть",
			"Своеобразие" => "Индивидуальность",
			"Своеобразие" => "Необыкновенность",
			"Своеобразие" => "Оригинальность",
			"Своеобразие" => "Самостоятельность",
			"Свойство" => "Качество",
			"Святотатство" => "Кощунство",
			"Сговорчивость" => "Податливость",
			"Сияние" => "Блеск",
			"Сказка" => "Легенда",
			"Скверна" => "Мерзость",
			"Скверность" => "Мерзость",
			...
			"Среда" => "Окружение",
			"Срок" => "Время",
			"Стандартность" => "Банальность",
			"Старательность" => "Старание",
			"Степенность" => "Величавость",
			"Стереотипность" => "Банальность",
			...
			"Тактичнсоть" => "Такт",
			"Талантливость" => "Одаренность",
			"Талантливость" => "Талант",
			"Тварь" => "Животное",
			"Творец" => "Бог",
			"Тема" => "Вопрос",
			"Темнота" => "Мрак",
			...
			"Узы" => "Оковы",
			"Уклад" => "Нравы",
			"Уклончивость" => "Двусмысленность",
			"Укор" => "Упрек",
			"Улучшение" => "Исправление",
			"Улучшение" => "Совершенствование",
			"Уменьшение" => "Ограничение",
			"Умильность" => "Трогательность",
			"Умонастроение" => "Настроение",
			"Умствование" => "Мудрствование",
			"Упоение" => "Горячность",
			"Упоение" => "Удовлетворение",
			...
			"Ценитель" => "Знаток",
			"Цепи" => "Оковы",
			"Церемонность" => "Величавость",
			"Чепуха" => "Вздор",
			"Чествование" => "Превознесение",
			"Чествование" => "Хвала",
			"Чопорность" => "Величавость",
			"Чушь" => "Вздор",
			"Шалость" => "Игра",
			"Шовинизм" => "Национализм",
			"Экономичность" => "Бережливость",
