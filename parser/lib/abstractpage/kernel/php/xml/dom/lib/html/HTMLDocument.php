...
using( 'xml.dom.lib.html.HTMLHtmlElement' );


/**
 * The Document-Class. This is the base class for all HTML documents.
 *
 * The HTMLDocument classes simply implements a different constructor!
...
class HTMLDocument extends Document
{
	...
	function HTMLDocument( $file = "" )
	{
		...
		{
			$this->create( "html" );
			$this->setDocumentElement( new HTMLHtmlElement );
		}
		else
		{
