...
/**
 * The HTMLParagraphElement-Class represents a paragraph element.
 *
...
class HTMLParagraphElement extends HTMLElement
{
	 ...
	 * Constructor
	 *
	 * @param	string		$value		The text portion of the paragraph element!
	 * @access	public
	 */
	function HTMLParagraphElement( $value="" )
	{
		$this->HTMLElement( "p", false );
