...
class NetGeo extends Base
{
	 ...
	 * @access public
	 */
	public function getAddressLocation( $address, &$location, $query = "getRecord" )
	{
		$location = array();
	 ...
	 * @access public
	 */
	public function calculateDistance( $longitude_1, $latitude_1, $longitude_2, $latitude_2 )
	{
