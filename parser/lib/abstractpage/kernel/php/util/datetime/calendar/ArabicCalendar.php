...
class ArabicCalendar extends PEAR
{
	/**
	 * @access public
	 */
	...
	function LastDayOfIslamicMonth( $Year, $aMonth )
   	{
		if ( ( ( $aMonth % 2 ) == 1 ) || ( ( $aMonth == 12 ) && IslamicLeapYear( $aYear ) ) )
			return 30;
		else
			return 29;
   }
	...
	function Ac_getDayName($aDay)
	{
		...
		{
			case 0:
				return $this->AC_Adaynames[0];
				break;

			case 1:
				return $this->AC_Adaynames[1];
				break;

			case 2:
				return $this->AC_Adaynames[2];
				break;
			
			case 3:
				return $this->AC_Adaynames[3];
				break;
			
			case 4:
				return $this->AC_Adaynames[4];
				break;
			
			case 5: 
				return $this->AC_Adaynames[5];
				break;
			
			case 6:
				return $this->AC_Adaynames[6];
				break;
		}
	}
   ...
   function Ac_getGDayName( $aDay )
   {
		...
		{
			case 0:
				return $this->AC_Gdaynames[0];
				break;

			case 1:
				return $this->AC_Gdaynames[1];
				break;

			case 2:
				return $this->AC_Gdaynames[2];
				break;
			
			case 3:
				return $this->AC_Gdaynames[3];
				break;
			
			case 4:
				return $this->AC_Gdaynames[4];
				break;
			
			case 5:
				return $this->AC_Gdaynames[5];
				break;
			
			case 6:
				return $this->AC_Gdaynames[6];
				break;
		}
	}
	...
	function Ac_getMonthName( $aMonth )
	{
		...
		{
			case 1:
				return $this->AC_AMonthName[1];
				break;

			case 2:
				return $this->AC_AMonthName[2];
				break;
			
			case 3:
				return $this->AC_AMonthName[3];
				break;
			
			case 4:
				return $this->AC_AMonthName[4];
				break;
			
			case 5:
				return $this->AC_AMonthName[5];
				break;
			
			case 6:
				return $this->AC_AMonthName[6];
				break;
			
			case 7:
				return $this->AC_AMonthName[7];
				break;
			
			case 8:
				return $this->AC_AMonthName[8];
				break;
			
			case 9:
				return $this->AC_AMonthName[9];
				break;
			
			case 10:
				return $this->AC_AMonthName[10];
				break;
			
			case 11:
				return $this->AC_AMonthName[11];
				break;

			case 12:
				return $this->AC_AMonthName[12];
				break;
		}
	}
