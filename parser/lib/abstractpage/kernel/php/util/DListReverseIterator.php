...
class DListReverseIterator extends DListIterator 
{
	/**
	 * Constructs the iterator with a DList reference.
	 *
	 * @param  &$dlist DList. A reference to a DList object
	 * @access public
	 */
	function DListReverseIterator( &$dlist ) 
	{
		$this->DListIterator( $dlist );
		$this->setNode( $dlist->getLastNode() );
	}
	

	/**
	 * Decrements the current node pointer, moving closer to the front of the
	 * list.
	 *
	 * @return void
	 * @access public
