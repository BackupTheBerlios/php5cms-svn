...
class OperatorPow extends BinaryOperator 
{
	/**
  	 * Constructor
	 *
	...
	function evalf() 
	{
		return pow( $this->operand1->evalf(), $this->operand2->evalf() );
	}
	...
	function evals() 
	{
        ...
        if ( $const1 && $const2 )
            return new Constant( pow( $arg1->evalf(), $arg2->evalf() ) );
        ...
        return new OperatorPow( $arg1, $arg2 );
	}
} // END OF OperatorPow
