 ...
 * var ciphertext = DES.crypt( key, message, 1, 0 );
...
DES.prototype = new Base();
DES.prototype.constructor = DES;
DES.superclass = Base.prototype;
 ...
 * @static
 */
DES.crypt = function( key, message, encrypt, mode, iv ) 
{
	...
	var cbcleft, cbcleft2, cbcright, cbcright2, i, j, temp, temp2, right1, right2, left, right, looping, endloop, loopinc;
