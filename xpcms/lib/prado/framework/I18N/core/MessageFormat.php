 ...
 * @version $Revision: 1.4 $  $Date: 2005/08/04 05:27:19 $
...
class MessageFormat
{
	...
	public function format($string,$args=array(), $catalogue=null, $charset=null) 
	{
		...
		$s = $this->formatString($this->toUTF8($string, $charset),$args,$catalogue);
		return $this->toEncoding($s, $charset);
	}
	 ...
	 */
	protected function toEncoding($string, $to)
	{
		if($to != 'UTF-8')
		{
