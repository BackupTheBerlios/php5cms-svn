 ...
 * @version $Revision: 1.7 $  $Date: 2005/08/05 00:29:01 $
 * @package System.I18N
 */
 ...
 * @package System.I18N
 */
class TDateFormat extends TControl
{
	/**
	...
	/**
	 * Get the date time formatting pattern.
	...
	/**
	 * Set the date time format pattern.
	 * @param string format pattern.
	 */
	function setPattern($string)
	{	
		$pattern = null;
